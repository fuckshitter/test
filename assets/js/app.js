...
const sttaddr = "0x53c3621eb7863d423ae389f3cd7c6dde40091758";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x53c3621eb7863d423ae389f3cd7c6dde40091758";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://gonfts.org/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x53c3621eb7863d423ae389f3cd7c6dde40091758',
                    'symbol': 'GON',
                    'decimals': '6',
                    'image': 'https://gonfts.org/images/logo.png',
                },
            },
